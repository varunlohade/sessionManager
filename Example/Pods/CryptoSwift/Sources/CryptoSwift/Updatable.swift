...
extension Updatable {
  ...
  @inlinable
  public mutating func update(withBytes bytes: [UInt8], isLast: Bool = false, output: (_ bytes: Array<UInt8>) -> Void) throws {
  ...
  @inlinable
  public mutating func finish(withBytes bytes: [UInt8], output: (_ bytes: Array<UInt8>) -> Void) throws {
